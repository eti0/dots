...
function window.build(w)
    ...
    i.input.css = "transition: 0.2s ease-in-out;"
    i.layout.css = "transition: 0.2s ease-in-out;"

    w.layout:pack(w.bar_layout)

    -- Other settings
    i.input.show_frame = true
    w.tabs.show_tabs = false

	-- margins
    -- status bar
    w.sbar.layout.margin_top = 10
    w.sbar.layout.margin_bottom = 10
    w.sbar.layout.margin_left = 10
    w.sbar.layout.margin_right = 10
    -- input bar
    w.ibar.layout.margin_top = 4
    w.ibar.layout.margin_bottom = 5
    w.ibar.layout.margin_left = 5
    w.ibar.layout.margin_right = 5
    -- tab bar
